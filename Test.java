...
import com.surya.beans.City_State;
import com.surya.beans.City_State_Collection;
...
//		///////////////////////////////////////
		...
		collection.getCityState();
		StandardEvaluationContext contexttt=new StandardEvaluationContext(collection);
		ExpressionParser parserr=new SpelExpressionParser();
		Expression expr5=parserr.parseExpression("l.?[city=='asansol']");
		List<City_State> al=(List<City_State>) expr5.getValue(contexttt);
		for(City_State city_State:al)
		{
			System.out.println(city_State.city);
			System.out.println(city_State.state);
		}
